  ...
  },
  {
    ...
    return (
        <div className="home-container">
            ...
            {/* DCAA Compliant Section */}
            <section className="dcaa-section">
                <div className="dcaa-container">
                    <h2 className="dcaa-title">DCAA Compliant - Timesheet System</h2>
                    <p className="dcaa-subtitle">Automate approvals, stay audit ready, and manage hours with confidence</p>
                    
                    <div className="dcaa-features">
                        <div className="dcaa-feature-card">
                            <div className="dcaa-icon">
                            ...
                            <p>Track every work hour with precision to boost productivity and accountability.</p>
                        </div>
                        ...
                        <div className="dcaa-feature-card">
                            ...
                            <p>Automatically record actions in detailed logs for effortless auditing.</p>
                        </div>
                        ...
                        <div className="dcaa-feature-card">
                            ...
                            <h3>Secure & Integrated</h3>
                            <p>Protect information and streamline processes across platforms effortlessly.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <footer className="footer">
                <div className="footer-container-centered">
                    <div className="footer-logo-section">
                        <img className="footer-logo-img" src={logo} alt="Thirno Logo" />
                        <p className="footer-description">
                            Thirno, managing your work, people, and progress becomes effortless – everything you need to stay organized, efficient, and audit-ready in one platform.
                        </p>
